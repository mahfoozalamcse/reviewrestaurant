package com.mahfooz.restaurant.services.impl;

import com.mahfooz.restaurant.domain.ReviewCreateUpdateRequest;
import com.mahfooz.restaurant.domain.entities.Photo;
import com.mahfooz.restaurant.domain.entities.Restaurant;
import com.mahfooz.restaurant.domain.entities.Review;
import com.mahfooz.restaurant.domain.entities.User;
import com.mahfooz.restaurant.exceptions.RestaurantNotFoundException;
import com.mahfooz.restaurant.exceptions.ReviewNotAllowedException;
import com.mahfooz.restaurant.repositories.RestaurantRepository;
import com.mahfooz.restaurant.services.ReviewService;
...
public class ReviewServiceImpl implements ReviewService {
    ...
    public Page<Review> listReviews(String restaurantId, Pageable pageable) {
        ...
        if(sort.isSorted()) {
            ...
            Comparator<Review> comparator = switch (property) {
                case "datePosted" -> Comparator.comparing(Review::getPostedAt);
                case "rating" -> Comparator.comparing(Review::getRating);
                default -> Comparator.comparing(Review::getPostedAt);
            };
    ...
    public Review updateReview(User author, String restaurantId, String reviewId, ReviewCreateUpdateRequest review) {
        ...
        if(LocalDateTime.now().isAfter(existingReview.getPostedAt().plusHours(48))) {
